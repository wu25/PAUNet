...
class BaseModel():
    ...
    def load_network(self, net, load_path, strict=True, param_key='params'):
        ...
        net.load_state_dict(load_net['params_ema'], strict=strict)
        # net = net.to(device)
        ...
        # net.load_state_dict(load_net['state_dict'], strict=strict)
    ...
    def resume_training(self, resume_state):
        ...
        # self.update_learning_rate(self, 52001, warmup_iter=-1)
